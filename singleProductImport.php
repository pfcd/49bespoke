...
$sel_prod = "SELECT * FROM test_virtuemart_products A JOIN test_virtuemart_products_en_gb B ON A.virtuemart_product_id=B.virtuemart_product_id WHERE A.product_sku IN ('2BR-EB2P1-LR-01', '2PR016', '2PR724', '2PR734', '2PR744', '2PRW540B-B', '2PRW540B-B.R', '2PRW540B-D', '2PRW540B-N', '2PRW540L-B')";
...
while($row_prod = $res_prod->fetch_assoc()){
	...
	if($product_id <= 0){
		$title = trim($row_prod['product_name']);
