<style>
.elex-banner-wrap .contact_support{
			...
			<div class="elex-banner-row">
				...
				<div class="elex-banner-row-content" id='elex-review-component'>
					...
					<div class="elex-banner-button-wrap">
						...
						<a  href="<?php echo esc_url( $this->data['documentation_url'] ); ?>"  class="button elex-btn-hover-light text-nowrap d-flex align-items-center gap-2"  target="_blank">
						...
						<a class="button  contact_support" href="<?php echo esc_url( $this->data['support_url'] ); ?>" target="_blank">
