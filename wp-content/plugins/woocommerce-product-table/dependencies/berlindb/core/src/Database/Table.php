...
abstract class Table extends Base
{
    ...
    {
        return (bool) (\defined('Barn2\\Plugin\\WC_Product_Table\\Dependencies\\WP_TESTS_DIR') && WP_TESTS_DIR) || \function_exists('Barn2\\Plugin\\WC_Product_Table\\Dependencies\\_manually_load_plugin');
    }
    /**
