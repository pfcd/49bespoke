...
class DSM_TextRotator extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$data_attr[] = array(
			...
			'pause'     => 'off' !== $text_rotator_pause_hover ? true : false,
			'click'     => 'off' !== $text_rotator_click_change ? true : false,
		...
		$output = sprintf(
			'<%1$s class="dsm-rotate-text-main et_pb_module_header">%4$s<span class="dsm-rotate-word">%2$s</span><span class="dsm-rotate-text" data-dsm-text-rotator=%3$s></span>%5$s</%1$s>',
