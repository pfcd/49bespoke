...
$single_products .= '<div class="dnwoo_product_carousel dnwoo_product_carousel_container ' . ' product_type_'.$product_type .' dnwoo_product_carousel_layout_five">';
...
$single_products .= sprintf(
    '<div class="dnwoo_product_imgwrap">
        ...
        %3$s
        %4$s
    <a href="%6$s" class="dnwoo_product_image_container"><img class="img-fluid dnwoo_product_image" src="%1$s" alt="%5$s"></a>
    %7$s',
...
$single_products .= sprintf(
    '<div class="dnwoo_product_content">
        <div class="dnwoo_product_categories">
            %4$s
            <a href="%5$s"><%8$s class="dnwoo_product_title">%1$s</%8$s></a>
            <p>%6$s</p>
            %7$s
            <div class="dnwoo_product_price">
                <div class="dnwoo_single_price">%2$s</div>
            </div>
            %3$s
        </div>
    </div></div>',
    $product->get_name(), //1
    'on' === $show_price_text ? $product->get_price_html() : '',//2
    'on' === $show_add_to_cart_btn ? $product_variant : '',//3
    $category_html,//4
    $permalink, //5
    'on' === $show_desc ? get_the_excerpt() : '', //6
