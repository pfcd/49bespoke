		...
		<div class="sbi-stck-el-list sbi-fb-fs">
			<?php foreach ($smashballoon_info['platforms'] as $platform): ?>
				<div class="sbi-stck-el sbi-fb-fs">
					...
					<div class="sbi-stck-el-icon" style="color:<?php echo $smashballoon_info['colorSchemes'][$platform['icon']] ?>;"><?php echo InstagramFeed\Builder\SBI_Feed_Builder::builder_svg_icons($platform['icon']); ?></div>
		...
		<div class="sbi-stck-follow sbi-fb-fs">
			...
			<div class="sbi-stck-flw-links">
				<?php foreach ($smashballoon_info['socialProfiles'] as $social_key => $social): ?>
					<a href="<?php echo esc_url($social); ?>" target="_blank" rel="noopener noreferrer" style="color:<?php echo $smashballoon_info['colorSchemes'][$social_key] ?>;"><?php echo InstagramFeed\Builder\SBI_Feed_Builder::builder_svg_icons($social_key); ?></a>
				<?php endforeach ?>
			</div>
		</div>
	</div>
