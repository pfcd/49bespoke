		...
		<div class="sbi-bld-ft-content">
			...
			<div class="sbi-txt-btn-wrapper">
				...
				<div class="sbi-bld-ft-action">
					<a :href="mainFooterScreen.link ? mainFooterScreen.link : links.allAccessBundle" target="_blank" class="sb-button sbi-btn-green">{{mainFooterScreen.learnMore}}
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M3.3335 11.7266L10.3935 4.66659H6.00016V3.33325H12.6668V9.99992H11.3335V5.60659L4.2735 12.6666L3.3335 11.7266Z" fill="white" />
						</svg>
					</a>
				</div>
			</div>
		</div>
		<div v-if="pluginType !== 'pro' && mainFooterScreen.promo !== ''" class="sbi-bld-ft-btm" v-html="mainFooterScreen.promo"></div>
	</div>
</div>
