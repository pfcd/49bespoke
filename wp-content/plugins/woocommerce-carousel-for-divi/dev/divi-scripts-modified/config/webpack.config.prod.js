  ...
  entry: {
    builder: [
      ...
      ...glob.sync([
        ...
        `${paths.appSrc}/fields/backend-style.css`
      ]),
    ],
	frontend: [
    ...
    function() {
      ...
      this.plugin('compilation', function (webpackCompilation) {
        webpackCompilation.plugin('optimize-chunk-assets', function(files, doneCb) {
          ...
          if ( webpackCompilation.assets['styles/style.min.css'] ) {
            ...
            ).process(webpackCompilation.assets['styles/style.min.css'].source()).then( function(prefixResult) {
              webpackCompilation.assets['styles/style-dbp.min.css'] = new sources.RawSource(prefixResult.css);
              saveUnminifiedFiles();
              minifyCssFiles();
            } );
