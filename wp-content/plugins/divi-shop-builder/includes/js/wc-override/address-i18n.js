...
This file (or the corresponding source JSX file) was last modified 2020-11-26
*/
...
jQuery( function( $ ) {
	...
	$( document.body )
		.bind( 'country_to_state_changing', function( event, country, wrapper ) {
			...
			// these are the only 3 line changes
			var type 	 	= wrapper.hasClass('woocommerce-billing-fields') ? 'billing' : 'shipping',
				locale_json = window.ags_address_i18n_params[type].replace( /&quot;/g, '"' ),
			...
			// this is a change from the plugin
