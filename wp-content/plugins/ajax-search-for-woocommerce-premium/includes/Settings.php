...
//				),
				...
				2200 => array(
					...
					'label'   => __( 'User search history', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'user-search-history',
			...
			'dgwt_wcas_search'       => apply_filters( 'dgwt/wcas/settings/section=search', array(
				...
				160 => array(
					...
					'type'    => 'checkbox',
					'desc'    => dgoraAsfwFs()->is_premium() ? __( 'searching also in variable products GUID',
						'ajax-search-for-woocommerce' ) : sprintf( __( 'Searching in variable products GUID is available only in <a target="_blank" href="%s">the pro version</a>.',
						'ajax-search-for-woocommerce' ), Upgrade::getUpgradeUrl() ),
					'default' => 'off',
	...
	public function listSearchableCustomFields__premium_only() {
		...
		wp_send_json_success( Helpers::getSearchableCustomFields() );
	}
