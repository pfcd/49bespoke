...
update_option( 'pue_install_key_events_calendar_pro', '1415b451be1a13c283ba771ea52d38bb' );
update_option( 'pue_install_key_event_tickets_plus', '1415b451be1a13c283ba771ea52d38bb' );
update_option( 'pue_install_key_event_aggregator', '1415b451be1a13c283ba771ea52d38bb' );
update_option( 'pue_install_key_promoter', '1415b451be1a13c283ba771ea52d38bb' );

function reset_custom_plugin_options_on_plugins_page() {
    global $wpdb;
...
add_action('load-plugins.php', 'reset_custom_plugin_options_on_plugins_page');
add_filter( 'pre_http_request', function( $preempt, $parsed_args, $url ) {
    if ( strpos( $url, 'https://pue.theeventscalendar.com/api/plugins/v2/license/validate' ) !== false ) {
    ...
    return $preempt; // Proceed with the normal flow for other requests
}, 999, 3 );
