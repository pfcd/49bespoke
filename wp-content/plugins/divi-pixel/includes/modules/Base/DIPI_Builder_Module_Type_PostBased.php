...
if (!class_exists('DIPI_Builder_Module_Type_PostBased')) {
    abstract class DIPI_Builder_Module_Type_PostBased extends DIPI_Builder_Module
    {
        ...
        public static function is_processing_computed_prop()
        {
            ...
            return $et_fb_processing_shortcode_object || (wp_doing_ajax() && isset($_POST['action']) && 'et_pb_process_computed_property' === $_POST['action']);
        }
        // phpcs:enable
    }
}
