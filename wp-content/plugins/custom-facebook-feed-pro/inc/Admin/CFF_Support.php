...
class CFF_Support
{
	...
	public function page_data()
	{
		...
		$return = array(
			...
			'icons' => array(
				'rocket' => CFF_PLUGIN_URL . 'admin/assets/img/rocket-icon.svg',
				'book' => CFF_PLUGIN_URL . 'admin/assets/img/book-icon.svg',
				'save' => CFF_PLUGIN_URL . 'admin/assets/img/save-plus-icon.svg',
