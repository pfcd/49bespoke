        ...
        <div class="cff-fb-source-top cff-fb-fs">
            ...
            <div class="cff-fb-types cff-fb-fs">
                <div class="cff-fb-types-list">
                    <div class="cff-fb-type-el" v-for="(feedTypeEl, feedTypeIn) in feedTypes" :data-active="choosedFeedTypeCustomizer(feedTypeEl.type)" @click.prevent.default="checkFeedTypeTier(feedTypeEl.type, true) ? chooseFeedType('normal', feedTypeEl, true) : viewsActive.extensionsPopupElement = feedTypeEl.type" >
