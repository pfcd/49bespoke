<div class="cff-fb-extensions-pp-ctn cff-license-why-renew sb-fs-boss cff-fb-center-boss" v-if="viewsActive.whyRenewLicense != null && viewsActive.whyRenewLicense != false">
	<div class="cff-fb-extensions-popup cff-fb-popup-inside cff-license-popup" v-if="viewsActive.whyRenewLicense != null && viewsActive.whyRenewLicense != false">
        <div class="cff-fb-popup-cls" @click.prevent.default="activateView('whyRenewLicense')">
