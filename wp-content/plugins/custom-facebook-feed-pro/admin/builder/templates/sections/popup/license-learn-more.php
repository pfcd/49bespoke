<div class="cff-license-learn-more cff-fb-extensions-pp-ctn sb-fs-boss cff-fb-center-boss" v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
	<div class="sbc-extensions-popup cff-fb-extensions-popup cff-fb-popup-inside cff-license-popup" v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
		<div class="cff-fb-popup-cls" @click.prevent.default="activateView('licenseLearnMore')">
		...
		<div>
			<div class="sb-llm-header">
				<h2 v-if="cffLicenseNoticeActive && !cffLicenseInactiveState">Your Facebook Feed Pro License is expired</h2>
				<h2 v-if="cffLicenseInactiveState">Your Facebook Feed Pro License is inactive</h2>
			...
			<div class="sb-llm-upgrade-benefits">
				...
				<div class="sb-benefits-block">
					...
					<p>With changes to Facebook and WordPress it's critical to keep your plugin up to date. We regularly provide fixes and enhancements in new releases</p>
				</div>
			...
			<div class="sb-llm-license-key-block">
				...
				<div class="sb-llm-lk-footer">
					<p>
						...
						<a href="<?php echo "https://smashballoon.com/pricing/facebook-feed/?utm_campaign=facebook-pro&utm_source=expired-notice&utm_medium=buy-license"; ?>" target="_blank">
							Buy a License
