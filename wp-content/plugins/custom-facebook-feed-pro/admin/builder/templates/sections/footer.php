		...
		<div class="cff-stck-el-list cff-fb-fs">
			<?php foreach ($smashballoon_info['platforms'] as $platform) : ?>
				<div class="cff-stck-el cff-fb-fs">
					...
					<a href="<?php echo esc_url($platform['link']) ?>" rel="nofollow noopener" target="_blank" class="cff-fs-a"></a>
				</div>
			<?php endforeach ?>
		</div>
		<div class="cff-stck-follow cff-fb-fs">
			...
			<div class="cff-stck-flw-links">
				<?php foreach ($smashballoon_info['socialProfiles'] as $social_key => $social) : ?>
					<a href="<?php echo esc_url($social); ?>" target="_blank" rel="nofollow noopener"  style="color:<?php echo $smashballoon_info['colorSchemes'][$social_key] ?>;"><?php echo $icons($social_key) ?></a>
				<?php endforeach ?>
			</div>
		</div>
	</div>
...
<?php
	...
	include_once CFF_BUILDER_DIR . 'templates/sections/popup/icalurl-popup.php';
