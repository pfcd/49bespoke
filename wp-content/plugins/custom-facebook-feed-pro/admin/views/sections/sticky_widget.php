<div class="cff-stck-wdg">
	...
	<div class="cff-stck-pop" v-if="stickyWidget">
		<div class="cff-stck-el cff-stck-el-upgrd sb-btn-orange">
			<div class="cff-stck-el-icon"><?php echo CustomFacebookFeed\Builder\CFF_Feed_Builder::builder_svg_icons($smashballoon_info['upgrade']['icon']); ?></div>
		...
		<div class="cff-stck-el-list cff-fb-fs">
			<?php foreach ($smashballoon_info['platforms'] as $platform) : ?>
				<div class="cff-stck-el cff-fb-fs">
					...
					<div class="cff-stck-el-icon" style="color:<?php echo $smashballoon_info['colorSchemes'][$platform['icon']] ?>;"><?php echo CustomFacebookFeed\Builder\CFF_Feed_Builder::builder_svg_icons($platform['icon']) ?></div>
		...
		<div class="cff-stck-follow cff-fb-fs">
			...
			<div class="cff-stck-flw-links">
				<?php foreach ($smashballoon_info['socialProfiles'] as $social_key => $social) : ?>
					<a href="<?php echo esc_url($social); ?>" target="_blank"  style="color:<?php echo $smashballoon_info['colorSchemes'][$social_key] ?>;"><?php echo CustomFacebookFeed\Builder\CFF_Feed_Builder::builder_svg_icons($social_key) ?></a>
				<?php endforeach ?>
			</div>
		</div>
	</div>
	<div class="cff-stck-wdg-btn" @click.prevent.default="toggleStickyWidget">
		<span v-if="!stickyWidget"><?php echo CustomFacebookFeed\Builder\CFF_Feed_Builder::builder_svg_icons('smash'); ?></span>
