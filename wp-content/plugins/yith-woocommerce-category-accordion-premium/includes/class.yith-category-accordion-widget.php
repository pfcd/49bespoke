	...
	class YITH_Category_Accordion_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			switch ( $how_show ) {
				case 'wc':
					...
					$show_sub_cat   = isset( $instance['show_wc_subcat'] ) ? $instance['show_wc_subcat'] : 'no';
					...
					if ( is_array( $exclude_wc_cat ) ) {
						$exclude_wc_cat = implode( ',', $exclude_wc_cat );
					}

					$string_build_shortcode .= 'show_sub_cat="' . $show_sub_cat . '" exclude_cat="' . $exclude_wc_cat . '" show_count="' . $show_count . '" show_wc_img="' . $show_wc_img . '" exclude_specific_cat="' . $exclude_specific_cat . '" ';
					break;
				case 'wp':
					$show_sub_cat   = $instance['show_wp_subcat'];
					$exclude_wp_cat    = $instance['exclude_wp_cat'];
                    $exclude_wp_cat_select    = $instance['exclude_wp_cat_select'];
                    $show_last_post = $instance['show_post'];
					$post_limit     = $instance['post_limit'];
					$show_count     = isset( $instance['show_count'] ) ? $instance['show_count'] : 'no';
					if ( is_array( $exclude_wp_cat ) ) {
						$exclude_wp_cat = implode( ',', $exclude_wp_cat );
					}
					$string_build_shortcode .= 'exclude_wp_cat_select="' . $exclude_wp_cat_select . '" show_sub_cat="' . $show_sub_cat . '" exclude_cat="' . $exclude_wp_cat . '" show_last_post="' . $show_last_post . '" post_limit="' . $post_limit . '" show_count="' . $show_count . '" ';
					break;
				case 'menu':
		...
		public function form( $instance ) {
            ...
            <style>
                ...
                .ywcca_exclude_pages_posts_hide {
                    display: none;
                }
            ...
            <div id="ywcca_widget_content">
                ...
                <div class="ywcca_exclude_page <?php echo $instance['hide_pages_posts'] === 'no' ?  esc_attr('ywcca_exclude_pages_posts_hide') : '';?>">
                ...
                <div class="ywcca_exclude_post <?php echo $instance['hide_pages_posts'] === 'no' ?  esc_attr('ywcca_exclude_pages_posts_hide') : '';?>">
