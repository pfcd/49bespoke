		...
		switch ( $how_show ) {
			case 'wc':
				...
				if ( is_array( $exclude_cat ) ) {
					...
					$exclude_specific_cat = 'yes';
				}

				$string_build_shortcode .= 'show_sub_cat="' . $show_sub_cat . '" exclude_specific_cat="' . $exclude_specific_cat . '" exclude_cat="' . $exclude_cat . '" show_count="' . $show_count . '" ';
				break;
			case 'wp':
			...
			case 'menu':
				...
				$menu_ids = array();
				if( is_array( $instance['include_menu'] ) ) {
