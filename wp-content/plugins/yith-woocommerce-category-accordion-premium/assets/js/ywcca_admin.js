...
jQuery(
	function( $ ) {
		...
		$(document).one('click', '.ywcca_select_field', function () {
				$(this).closest('#ywcca_widget_content').find('.yith-plugin-ui-exclude-specific-cat input').change();
			}
		);
		...
		$(document).on('change', '.yith-plugin-ui-hide-pages-post input', function () {
				$('.ywcca_exclude_page').removeClass('ywcca_exclude_pages_posts_hide');
				$('.ywcca_exclude_post').removeClass('ywcca_exclude_pages_posts_hide');
		...
		/********************************************************************************/
		/*modificar el selector para que funcione correctamente*/

		/*$(document).one('click', '.ywcca_select_field', function () {
				$(this).closest('#ywcca_widget_content').find('.yith-plugin-ui-exclude-wp-cat-select input').change();
			}
		);*/
