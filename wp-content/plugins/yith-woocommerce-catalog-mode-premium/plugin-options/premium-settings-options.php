...
$admin_override             = '';
$enable_maxmind_geolocation = array(
	'type'      => 'yith-field',
	'yith-type' => 'onoff',
	'desc'      => esc_html__( 'Enable to use the MaxMind service for your customers geolocation. This service can improve Geolocation accuracy.', 'yith-woocommerce-catalog-mode' ),
	'name'      => esc_html__( 'Enable MaxMind Geolocation', 'yith-woocommerce-catalog-mode' ),
	'id'        => 'ywctm_enable_geolocation_maxmind',
	'default'   => 'no',
	'deps'      => array(
		'id'    => 'ywctm_enable_geolocation',
		'value' => 'yes',
		'type'  => 'hide-disable',
	),
);
$maxmind_geolocation_apikey = array(
	'type'      => 'yith-field',
	'yith-type' => 'password',
	/* translators: %1$s: opening link tag, %2$s: closing link tag  */
	'desc'      => sprintf( esc_html__( 'The key that will be used when dealing with MaxMind Geolocation services. You can read how to generate one in %1$s MaxMind Geolocation Integration documentation %2$s.', 'yith-woocommerce-catalog-mode' ), '<a href="https://docs.woocommerce.com/document/maxmind-geolocation-integration/">', '</a>' ),
	'name'      => esc_html__( 'MaxMind License Key', 'yith-woocommerce-catalog-mode' ),
	'id'        => 'ywctm_maxmind_geolocation_license_key',
	'default'   => '',
	'deps'      => array(
		'id'    => 'ywctm_enable_geolocation_maxmind',
		'value' => 'yes',
...
if ( ywctm_is_multivendor_active() ) {
	if ( '' === ywctm_get_vendor_id( true ) ) {
		...
		$enable_maxmind_geolocation = '';
		$maxmind_geolocation_apikey = '';
	}
}
...
$settings = array(
	'premium-settings' => array(
		...
		'enable_geolocation_maxmind'    => $enable_maxmind_geolocation,
		'maxmind_geolocation_apikey'    => $maxmind_geolocation_apikey,
		'geolocation_options'           => array(
			...
			'fields'    => array(
				...
				'countries' => array(
					...
					'type'         => 'select-buttons',
					'buttons'      => array(),
					'class'        => 'ywctm-add-line-separator',
				),
			),
			'class'     => 'ywctm-inline-selects',
			'deps'      => array(
