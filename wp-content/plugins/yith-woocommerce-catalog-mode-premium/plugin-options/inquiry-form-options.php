...
return array(
	'inquiry-form' => array(
		'inquiry_form_title'               => array(
			'name' => esc_html__( 'General options', 'yith-woocommerce-catalog-mode' ),
			'type' => 'title',
		),
		...
		'default_form_fields_settings'     => array(
			'name' => esc_html_x( 'Default form fields', 'Admin options title', 'yith-woocommerce-catalog-mode' ),
			'type' => 'title',
			'id'   => 'ywctm_default_form_fields_settings',
		),
		...
		'reCAPTCHA'                        => array(
			...
			'desc'      => sprintf( esc_html_x( 'Enable to add reCAPTCHA option in default form. %1$s To start using reCAPTCHA V2, you need to %2$ssign up for an API key%3$s pair for your site.', 'string with placeholder do not translate or remove it', 'yith-woocommerce-catalog-mode' ), '<br>', '<a href="https://www.google.com/recaptcha/admin">', '</a>' ),
		...
		'default_form_fields_settings_end' => array(
			'type' => 'sectionend',
			'id'   => 'ywctm_default_form_fields_settings_end',
		),
		'form_options_settings'            => array(
			'name' => esc_html_x( 'Form options', 'Admin options title', 'yith-woocommerce-catalog-mode' ),
			'type' => 'title',
			'id'   => 'ywctm_form_options_settings',
		),
		'where_show'                       => array(
