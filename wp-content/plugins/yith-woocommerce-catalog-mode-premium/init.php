...
yith_deactivate_plugins( 'YWCTM_FREE_INIT', plugin_basename( __FILE__ ) );
...
add_action( 'before_woocommerce_init', 'ywctm_declare_hpos_compatibility' );
 ...
 * @since  2.18.0
 */
function ywctm_declare_hpos_compatibility() {
