...
jQuery(
	function ( $ ) {
		...
		var selected_icon_row           = $( '.ywctm_selected_icon' ),
			selected_icon_size_row      = $( '.ywctm_selected_icon_size' ),
			selected_icon_alignment_row = $( '.ywctm_selected_icon_alignment' ),
			icon_color_row              = $( '.ywctm_icon_color' ),
			custom_icon_row             = $( '.ywctm_custom_icon' );
		...
		var back_button_list_link = $( '.yith-plugin-ui--ywctm-button-label-post_type div.ywctm-metabox-topbar' ),
			page_title            = $( '.yith-plugin-fw__panel__content .yith-plugin-ui--ywctm-button-label-post_type .wrap > .wp-heading-inline' );

		page_title.before( back_button_list_link );

		$( '.yith-plugin-fw__panel__option.yith-plugin-fw__panel__option--textarea-editor.ywctm_label_text .wp-media-buttons #insert-media-button' ).siblings().remove();
	}
);
