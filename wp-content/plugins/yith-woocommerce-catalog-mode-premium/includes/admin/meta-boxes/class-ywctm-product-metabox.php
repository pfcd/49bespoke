 ...
 *
 * @package YITH\CatalogMode\Admin\MetaBoxes
 */
...
if ( ! class_exists( 'YWCTM_Product_Metabox' ) ) {
	...
	class YWCTM_Product_Metabox {
		...
		public function init() {
			...
			if ( ywctm_is_multivendor_active() && ! ywctm_is_multivendor_integration_active() && ! current_user_can( 'manage_woocommerce' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown
				return;
			}
