<?php
/**
 * Support class for custom tables
 *
 * @package YITH\CatalogMode\Admin
 */
...
if ( ! class_exists( 'YITH_YWCTM_Custom_Table' ) ) {

	/**
	 * Shows a custom table
	 *
	 * @class   YITH_YWCTM_Custom_Table
	 * @since   1.0.0
	 * @author  YITH <plugins@yithemes.com>
	 * @extends WP_List_Table
	 * @package YITH\CatalogMode\Admin
	 */
	class YITH_YWCTM_Custom_Table extends WP_List_Table {
