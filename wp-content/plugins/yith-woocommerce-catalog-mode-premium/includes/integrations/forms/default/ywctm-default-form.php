 ...
 *
 * @package YITH\CatalogMode\Integrations\Forms\Default
...
if ( ! function_exists( 'ywctm_get_field_types' ) ) {
	...
	function ywctm_get_field_types() {
		return array(
			'text'             => _x( 'Text', 'Text field', 'yith-woocommerce-catalog-mode' ),
			'email'            => _x( 'Email', 'Email field', 'yith-woocommerce-catalog-mode' ),
			'textarea'         => _x( 'Textarea', 'Textarea field', 'yith-woocommerce-catalog-mode' ),
			'ywctm_acceptance' => _x( 'Acceptance', 'Field to add the Acceptance on form', 'yith-woocommerce-catalog-mode' ),
		);
	}
}
