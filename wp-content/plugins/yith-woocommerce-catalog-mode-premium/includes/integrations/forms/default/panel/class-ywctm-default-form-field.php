 ...
 *
 * @package YITH\CatalogMode\Integrations\Forms\Default\Panel
 */
...
if ( ! class_exists( 'YWCTM_Default_Form_Field' ) ) {
	...
	class YWCTM_Default_Form_Field {
		...
		public function enqueue_styles_scripts() {
			...
			if ( ! empty( $getted['page'] ) && ( 'yith_wc_catalog_mode_panel' === $getted['page'] || 'yith_vendor_ctm_settings' === $getted['page'] ) ) {
