 ...
 *
 * @package YITH\CatalogMode\Integrations\Forms\GravityForms
...
if ( ! function_exists( 'ywctm_gravity_forms_message' ) ) {
	...
	function ywctm_gravity_forms_message( $components, $mail_format ) {
		...
		if ( isset( $request['ywctm-product-id'] ) ) {
			...
			if ( apply_filters( 'ywctm_get_vendor_option', get_option( 'ywctm_inquiry_product_permalink' ), $product_id, 'ywctm_inquiry_product_permalink' ) === 'yes' ) {
