...
class WC_Fashion_Admin_Info {
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('WC Fashion Theme', 'wc-fashion'),
            esc_html__('WC Fashion Theme', 'wc-fashion'),
            'edit_theme_options',
            'wc-fashion',
    ...
    public function check_rt_easy_builder_freemius() {
        ...
        // Add your actions
            ...
            add_action( 'wp_ajax_dismiss_wc_fashion_notification', array( $this, 'dismiss_notification_ajax_handler' ) );
        }
    }
    ...
    public function reset_notification_dismissal() {
        delete_transient('wc_fashion_notification_dismissed');
    }
    ...
    public function compatible_check() {
        ...
        $dismissed = get_transient('wc_fashion_notification_dismissed');
        if ($dismissed !== '1') {
    ...
    public function dismiss_notification() {
        ...
        set_transient('wc_fashion_notification_dismissed', '1', 7 * DAY_IN_SECONDS);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_wc_fashion_notification',
...
// Instantiate the WC Fashion Admin Info class
new WC_Fashion_Admin_Info();
