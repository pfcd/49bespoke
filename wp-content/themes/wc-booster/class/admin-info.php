...
class WC_Booster_Admin_Info {
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('WC Booster Theme', 'wc-booster'),
            esc_html__('WC Booster Theme', 'wc-booster'),
            'edit_theme_options',
            'wc-booster',
    ...
    public function check_rt_easy_builder_freemius() {
        ...
        // Add your actions
            ...
            add_action( 'wp_ajax_dismiss_wc_booster_notification', array( $this, 'dismiss_notification_ajax_handler' ) );
        }
    }
    ...
    public function reset_notification_dismissal() {
        delete_transient('wc_booster_notification_dismissed');
    }
    ...
    public function compatible_check() {
        ...
        $dismissed = get_transient('wc_booster_notification_dismissed');
        if ($dismissed !== '1') {
    ...
    public function dismiss_notification() {
        ...
        set_transient('wc_booster_notification_dismissed', '1', 7 * DAY_IN_SECONDS);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_wc_booster_notification',
...
// Instantiate the WC Booster Admin Info class
new WC_Booster_Admin_Info();
