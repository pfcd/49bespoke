...
$username = "root";
$password = "6!8FZV!q*NPRqo";
$dbname = "49bespoke_joomla";
...
// SELECT Parent - Parent
	$sel_prod = "SELECT * FROM test_virtuemart_products A JOIN test_virtuemart_products_en_gb B ON A.virtuemart_product_id=B.virtuemart_product_id WHERE A.virtuemart_product_id = '3366'";
